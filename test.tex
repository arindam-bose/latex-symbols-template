...
\usepackage{lipsum, fancyvrb, fvextra}
\input{symbols.tex}
...
\begin{document}
	...
	\subsection{Subsec}
	The following is an example of a \texttt{subsec}. It is like a subsection but do not create any new numbering. It just creates a new paragraph with the argument as the title of the paragraph. Some texts are required before calling the \verb|subsec| command as it always invokes a \texttt{newline}.
	\subsec{Example} does this.
	\begin{verbatim}
		\subsec{Example} does this.
	\end{verbatim}
